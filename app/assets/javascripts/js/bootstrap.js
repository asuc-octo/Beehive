...
+function ($) { "use strict";
  ...
  $(document).on('click.bs.collapse.data-api', '[data-toggle=collapse]', function (e) {
    ...
    var target  = $this.attr('data-target')
        || e.preventDefault()
        || (href = $this.attr('href')) && href.replace(/.*(?=***REMOVED***[^\s]+$)/, '') //strip for ie7
    var $target = $(target)
...
+function ($) { "use strict";
  ...
  function getParent($this) {
    ...
    if (!selector) {
      selector = $this.attr('href')
      selector = selector && /***REMOVED***/.test(selector) && selector.replace(/.*(?=***REMOVED***[^\s]*$)/, '') //strip for ie7
    }
...
+function ($) { "use strict";
  ...
  $(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
    ...
    var option  = $target.data('modal') ? 'toggle' : $.extend({ remote: !/***REMOVED***/.test(href) && href }, $target.data(), $this.data())
...
+function ($) { "use strict";
  ...
  function ScrollSpy(element, options) {
    ...
    this.selector       = (this.options.target
      || ((href = $(element).attr('href')) && href.replace(/.*(?=***REMOVED***[^\s]+$)/, '')) //strip for ie7
      || '') + ' .nav li > a'
    this.offsets        = $([])
    this.targets        = $([])
  ...
  ScrollSpy.prototype.refresh = function () {
    ...
    var $targets = this.$body
      ...
      .map(function () {
        ...
        var $href = /^***REMOVED***\w/.test(href) && $(href)
