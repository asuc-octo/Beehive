...
$(function() { 
  ...
  autocomplete_setup('/courses/json', '***REMOVED***courses-input', 20);
  autocomplete_setup('/categories/json', '***REMOVED***categories-input', 50);
  autocomplete_setup('/proglangs/json', '***REMOVED***proglangs-input', 20);
});
