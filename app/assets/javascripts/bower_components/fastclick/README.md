...
[日本語で説明](https://developer.mozilla.org/ja/docs/Mozilla/Firefox_OS/Apps/Tips_and_techniques***REMOVED***Make_events_immediate)。

***REMOVED******REMOVED*** Why does the delay exist? ***REMOVED******REMOVED***

According to [Google](https://developers.google.com/mobile/articles/fast_buttons):

> ...mobile browsers will wait approximately 300ms from the time that you tap the button to fire the click event. The reason for this is that the browser is waiting to see if you are actually performing a double tap.

***REMOVED******REMOVED*** Compatibility ***REMOVED******REMOVED***
...
***REMOVED******REMOVED*** When it isn't needed ***REMOVED******REMOVED***
...
***REMOVED******REMOVED*** Usage ***REMOVED******REMOVED***
...
Don't forget to add a [shim](https://developer.mozilla.org/en-US/docs/DOM/EventTarget.removeEventListener***REMOVED***Compatibility) for `addEventListener` if you want to support IE8 and below.
...
***REMOVED******REMOVED******REMOVED*** Minified ***REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED*** AMD ***REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED*** Package managers ***REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED*** Advanced ***REMOVED******REMOVED***

***REMOVED******REMOVED******REMOVED*** Ignore certain elements with `needsclick` ***REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Use case 1: non-synthetic click required ***REMOVED******REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Use case 2: Twitter Bootstrap 2.2.2 dropdowns ***REMOVED******REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED*** Tests ***REMOVED******REMOVED***
...
***REMOVED******REMOVED*** Credits and collaboration ***REMOVED******REMOVED***
