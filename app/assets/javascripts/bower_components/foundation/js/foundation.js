  ...
  */
  ...
  window.matchMedia = window.matchMedia || (function( doc, undefined ) {
    ...
    return function (q) {
      ...
      div.innerHTML = "&shy;<style media=\"" + q + "\"> ***REMOVED***mq-test-1 { width: 42px; }</style>";
  ...
  Foundation.libs.abide = {
    ...
    settings : {
      ...
      patterns : {
        ...
        // http://www.whatwg.org/specs/web-apps/current-work/multipage/states-of-the-type-attribute.html***REMOVED***valid-e-mail-address
        email : /^[a-zA-Z0-9.!***REMOVED***$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,

        url: /(https?|ftp|file|ssh):\/\/(((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\***REMOVED***((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?/,
        // abc.de
        ...
        // ***REMOVED***FFF or ***REMOVED***FFFFFF
        color: /^***REMOVED***?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/
      }
    },
    ...
    events : function () {
      ...
      .on('click.fndtn.accordion', '[' + this.attr_name() + '] dd > a', function (e) {
        var accordion = S(this).closest('[' + self.attr_name() + ']'),
            target = S('***REMOVED***' + this.href.split('***REMOVED***')[1]),
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.clearing = {
    ...
    settings : {
      templates : {
        viewing : '<a href="***REMOVED***" class="clearing-close">&times;</a>' +
          '<div class="visible-img" style="display: none"><div class="clearing-touch-label"></div><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" alt="" />' +
          '<p class="clearing-caption"></p><a href="***REMOVED***" class="clearing-main-prev"><span></span></a>' +
          '<a href="***REMOVED***" class="clearing-main-next"><span></span></a></div>'
      },
    ...
    assemble : function ($li) {
      ...
      var holder = this.S('***REMOVED***foundationClearingHolder'),
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.dropdown = {
      ...
      S(this.scope)
        ...
        .on('mouseenter.fndtn.dropdown', '[' + this.attr_name() + '], [' + this.attr_name() + '-content]', function (e) {
          ...
          if ($this.data(self.data_attr())) {
            var dropdown = S('***REMOVED***' + $this.data(self.data_attr())),
                target = $this;
          } else {
            var dropdown = $this;
        ...
        .on('mouseleave.fndtn.dropdown', '[' + this.attr_name() + '], [' + this.attr_name() + '-content]', function (e) {
          ...
          self.timeout = setTimeout(function () {
            if ($this.data(self.data_attr())) {
              ...
              if (settings.is_hover) self.close.call(self, S('***REMOVED***' + $this.data(self.data_attr())));
            } else {
    ...
    toggle : function (target) {
      var dropdown = this.S('***REMOVED***' + target.data(this.data_attr()));
    ...
    settings : {
      ...
      directives : {
        replace: function (el, path, trigger) {
          ...
          // $('***REMOVED***interchangeContainer').on('replace', function (e, a, b, c) {
          ...
          var regex = "/^.(\.jpg|\.jpeg|\.png|\.gif|\.tiff|\.bmp)\??|***REMOVED***?./";
  ...
  Foundation.libs.joyride = {
    ...
    defaults : {
      ...
      template : { // HTML segments for tip layout
        link    : '<a href="***REMOVED***close" class="joyride-close-tip">&times;</a>',
        timer   : '<div class="joyride-timer-indicator-wrap"><span class="joyride-timer-indicator"></span></div>',
        tip     : '<div class="joyride-tip-guide"><span class="joyride-nub"></span></div>',
        wrapper : '<div class="joyride-content-wrapper"></div>',
        button  : '<a href="***REMOVED***" class="small button joyride-next-tip"></a>',
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs['magellan-expedition'] = {
    ...
    events : function () {
      ...
      S(self.scope)
        .off('.magellan')
        .on('click.fndtn.magellan', '[' + self.add_namespace('data-magellan-arrival') + '] a[href^="***REMOVED***"]', function (e) {
            e.preventDefault();
            var expedition = $(this).closest('[' + self.attr_name() + ']'),
                settings = expedition.data('magellan-expedition-init');

            var hash = this.hash.split('***REMOVED***').join(''),
                target = $('a[name='+hash+']');
            if (target.length === 0) target = $('***REMOVED***'+hash);
            ...
            $('html, body').stop().animate({
                ...
                window.location.hash = '***REMOVED***'+hash;
            });
        })
  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.navigation_arrows) {
        container.append($('<a href="***REMOVED***"><span></span></a>').addClass(settings.prev_class));
        container.append($('<a href="***REMOVED***"><span></span></a>').addClass(settings.next_class));
      }
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.reveal = {
    ...
    // PATCH ***REMOVED***3: turning on key up capture only when a reveal window is open
    key_up_on : function (scope) {
      var self = this;

      // PATCH ***REMOVED***1: fixing multiple keyup event trigger from single key press
      self.S('body').off('keyup.fndtn.reveal').on('keyup.fndtn.reveal', function ( event ) {
        var open_modal = self.S('[' + self.attr_name() + '].open'),
            settings = open_modal.data(self.attr_name(true) + '-init');
        // PATCH ***REMOVED***2: making sure that the close event can be called only while unlocked,
    ...
    open : function (target, ajax_settings) {
      ...
      if (target) {
        if (typeof target.selector !== 'undefined') {
          var modal = self.S('***REMOVED***' + target.data(self.data_attr('reveal-id')));
        } else {
      ...
      if (!modal.hasClass('open')) {
        ...
        this.key_up_on(modal);    // PATCH ***REMOVED***3: turning on key up capture only when a reveal window is open
        modal.trigger('open');
    ...
    close : function (modal) {
      ...
      if (open_modals.length > 0) {
        this.locked = true;
        this.key_up_off(modal);   // PATCH ***REMOVED***3: turning on key up capture only when a reveal window is open
        modal.trigger('close');
        this.toggle_bg(modal);
  ...
  Foundation.libs.tab = {
          ...
          if (hash != '') {
            ...
            if (hash_element.hasClass('content') && hash_element.parent().hasClass('tab-content')) {
              ...
              if (hash_tab_container_id != undefined) {
                self.toggle_active_tab($('[' + self.attr_name() + '] > dd > a[href=***REMOVED***' + hash_tab_container_id + ']').parent(), hash);
              }
            }
          } else {
    ...
    toggle_active_tab: function (tab, location_hash) {
      var S = this.S,
          ...
          target_hash = '***REMOVED***' + anchor.attr('href').split('***REMOVED***')[1],
      ...
      if (S(this).data(this.data_attr('tab-content'))) {
        target_hash = '***REMOVED***' + S(this).data(this.data_attr('tab-content')).split('***REMOVED***')[1];
        target = S(target_hash);
      }
  ...
  Foundation.libs.topbar = {
    ...
    events : function (bar) {
      ...
      S(this.scope)
        ...
        .on('click.fndtn.topbar','.top-bar .top-bar-section li a[href^="***REMOVED***"],[' + this.attr_name() + '] .top-bar-section li a[href^="***REMOVED***"]',function (e) {
