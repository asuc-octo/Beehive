...
Hyphenation is language specific, sometimes.
  See for more details: http://code.google.com/p/hyphenator/source/diff?spec=svn975&r=975&format=side&path=/trunk/Hyphenator.js***REMOVED***sc_svn975_313
...
(function() {
	...
	Modernizr.addTest("softhyphens", function() {
		try {
			...
			return test_hyphens('&***REMOVED***173;', true) && test_hyphens('&***REMOVED***8203;', false);
		} catch(e) {
			return false;
		}
	});
	...
	Modernizr.addTest("softhyphensfind", function() {
		try {
			return test_hyphens_find('&***REMOVED***173;') && test_hyphens_find('&***REMOVED***8203;');
		} catch(e) {
			return false;
		}
	});
