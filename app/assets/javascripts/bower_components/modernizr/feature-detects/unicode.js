...
Modernizr.addTest('unicode', function() {
	...
	Modernizr.testStyles('***REMOVED***modernizr{font-family:Arial,sans;font-size:300em;}', function(node) {

		missingGlyph.innerHTML = '&***REMOVED***5987';
		star.innerHTML = '&***REMOVED***9734';		
