...
test('html shim worked', function(){
  ...
  ok( /red|***REMOVED***ff0000/i.test(elem.style.color), 'unknown elements are styleable')
  	...
  	return function( query ) {
  		if ( !( query in cache ) ) {
  			var styleBlock = document.createElement('style'),
          		cssrule = "@media " + query + " { ***REMOVED***jquery-mediatest { position:absolute; } }";
...
test('Modernizr.testStyles()',function(){
  ...
  var style = '***REMOVED***modernizr{ width: 9px; height: 4px; font-size: 0; color: papayawhip; }';
...
test('Modernizr.prefixed autobind', function(){
  ...
  equal(
    false,
    Modernizr.prefixed('doSomethingAmazing$***REMOVED***$', window),
    "Modernizr.prefixed('doSomethingAmazing$***REMOVED***$', window) : Gobbledygook with prefixed(str,obj) returns false");

  equal(
    false,
    Modernizr.prefixed('doSomethingAmazing$***REMOVED***$', window, document.body),
    "Modernizr.prefixed('doSomethingAmazing$***REMOVED***$', window) : Gobbledygook with prefixed(str,obj, scope) returns false");


  equal(
    false,
    Modernizr.prefixed('doSomethingAmazing$***REMOVED***$', window, false),
    "Modernizr.prefixed('doSomethingAmazing$***REMOVED***$', window) : Gobbledygook with prefixed(str,obj, false) returns false");
