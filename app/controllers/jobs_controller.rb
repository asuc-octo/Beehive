  ...
  def create
    ...
    respond_to do |format|
      if @job.valid_without_sponsorships? and sponsor
        ...
        @job.active =  true     ***REMOVED*** TODO: remove this at some point
        @job.save
        ...
        ***REMOVED*** TODO refactor
        if Rails.production?
          begin
            ...
            Rails.logger.warn "jobs***REMOVED***create: Unable to reindex: ***REMOVED***{e.inspect}"
          end
        end
    ...
    ***REMOVED*** /jobs/activate/job_id?a=xxx
    ...
    if Rails.production?
      begin
        ...
        Rails.logger.warn "jobs***REMOVED***activate: Unable to reindex: ***REMOVED***{e.inspect}"
      end
    end
