...
class SessionsController < ApplicationController
  ...
  ***REMOVED*** before_filter :set_setjmp, :only => [:new] ***REMOVED*** Remember previous page when logging in
  ...
  def set_setjmp
    return ***REMOVED*** TODO: this causes redirect loop when clicking post listing with no user
...
***REMOVED***      redirect_to (flash[:setjmp] || dashboard_path)
***REMOVED***      flash[:setjmp] = nil
