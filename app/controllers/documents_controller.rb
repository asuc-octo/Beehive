...
def create
    ...
    ***REMOVED*** Process document type
    ...
    if @document.save
        flash[:notice] = "Thanks for the upload! It should now show up in your profile. paramsdoctype=***REMOVED***{params[:document][:document_type]}, doctype=***REMOVED***{@document.document_type}"
    else
