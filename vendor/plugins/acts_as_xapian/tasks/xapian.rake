...
namespace :xapian do
    ***REMOVED*** Parameters - specify "flush=true" to save changes to the Xapian database
    ***REMOVED*** after each model that is updated. This is safer, but slower. Specify
    ***REMOVED*** "verbose=true" to print model name as it is run.
    ...
    ***REMOVED*** Parameters - specify 'models="PublicBody User"' to say which models
    ***REMOVED*** you index with Xapian.
    ***REMOVED*** This totally rebuilds the database, so you will want to restart any
    ***REMOVED*** web server afterwards to make sure it gets the changes, rather than
    ***REMOVED*** still pointing to the old deleted database. Specify "verbose=true" to
    ***REMOVED*** print model name as it is run.
    ...
    ***REMOVED*** Parameters - are models, query, offset, limit, sort_by_prefix,
    ***REMOVED*** collapse_by_prefix
