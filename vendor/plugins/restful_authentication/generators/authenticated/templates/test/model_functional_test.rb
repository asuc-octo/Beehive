...
***REMOVED*** Re-raise errors caught by the controller.
...
class <%= model_controller_class_name %>ControllerTest < ActionController::TestCase
  ***REMOVED*** Be sure to include AuthenticatedTestHelper in test/test_helper.rb instead
  ***REMOVED*** Then, you can remove it from this and the units test.
  ...
  def test_should_not_activate_user_without_key
    ...
    ***REMOVED*** in the event your routes deny this, we'll just bow out gracefully.
  end
