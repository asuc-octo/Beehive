...
***REMOVED***
***REMOVED*** User account actions.
***REMOVED***
***REMOVED*** The ! methods are 'just get the job done'.  It's true, they do some testing of
***REMOVED*** their own -- thus un-DRY'ing tests that do and should live in the user account
***REMOVED*** stories -- but the repetition is ultimately important so that a faulty test setup
***REMOVED*** fails early.
***REMOVED***
