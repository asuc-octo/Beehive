...
an argument.
  ...
  ***REMOVED*** Returns array of Post objects.
  my_search_results = Post.with_query('my search query')
  
  ***REMOVED*** Chain it with any number of ActiveRecord methods and named_scopes.
  my_search_results = Post.public.with_query('my search query').find(:all, :limit => 10) ***REMOVED*** return the first 10 matches which are public.
