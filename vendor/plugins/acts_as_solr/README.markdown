...
======
<pre><code>
***REMOVED*** Just include the line below to any of your ActiveRecord models:
  acts_as_solr

***REMOVED*** Or if you want, you can specify only the fields that should be indexed:
  acts_as_solr :fields => [:name, :author]

***REMOVED*** Then to find instances of your model, just do:
  Model.find_by_solr(query) ***REMOVED***query is a string representing your query

***REMOVED*** Please see ActsAsSolr::ActsMethods for a complete info
...
([via](http://www.subelsky.com/2007/10/actsassolr-capistranhttpwwwbloggercomim.html***REMOVED***c1646308013209805416))
