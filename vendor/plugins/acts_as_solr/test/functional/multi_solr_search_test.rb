...
class ActsAsSolrTest < Test::Unit::TestCase
  ...
  ***REMOVED*** Testing the multi_solr_search with the returning results being objects
  ...
  ***REMOVED*** Testing the multi_solr_search with the returning results being ids
  ...
  ***REMOVED*** Testing the multi_solr_search with multiple models
  ...
  ***REMOVED*** Testing empty result set format
