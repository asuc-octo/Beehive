...
class Solr::Request::Standard < Solr::Request::Select
  ...
  def initialize(params)
    ...
    raise "Invalid parameters: ***REMOVED***{(params.keys - VALID_PARAMS).join(',')}" unless 
    ...
    ***REMOVED*** Validate start, rows can be transformed to ints
  ...
  def to_hash
    ...
    ***REMOVED*** facet parameter processing
    if @params[:facets]
      ***REMOVED*** TODO need validation of all that is under the :facets Hash too
      hash[:facet] = true
      hash["facet.field"] = []
      ...
      if @params[:facets][:fields]  ***REMOVED*** facet fields are optional (could be facet.query only)
        @params[:facets][:fields].each do |f|
          if f.kind_of? Hash
            key = f.keys[0]
            value = f[key]
            hash["facet.field"] << key
            hash["f.***REMOVED***{key}.facet.sort"] = (value[:sort] == :count) if value[:sort]
            hash["f.***REMOVED***{key}.facet.limit"] = value[:limit]
            hash["f.***REMOVED***{key}.facet.missing"] = value[:missing]
            hash["f.***REMOVED***{key}.facet.mincount"] = value[:mincount]
            hash["f.***REMOVED***{key}.facet.prefix"] = value[:prefix]
            hash["f.***REMOVED***{key}.facet.offset"] = value[:offset]
          else
            hash["facet.field"] << f
          end
        end
        ...
        if @params[:date_facets][:fields]
          @params[:date_facets][:fields].each do |f|
            if f.kind_of? Hash
              ...
              hash["facet.date"] << key
              f[key].each { |k, v|
                hash["f.***REMOVED***{key}.facet.date.***REMOVED***{k}"] = v
              }
            else
              hash["facet.date"] << f
            end
    ...
    ***REMOVED*** highlighting parameter processing - http://wiki.apache.org/solr/HighlightingParameters
        ...
        if snippets.kind_of? Hash
          ...
          if snippets[:fields]
            snippets[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.snippets"] = v
            end
          end
        else
        ...
        if fragsize.kind_of? Hash
          ...
          if fragsize[:fields]
            fragsize[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.fragsize"] = v
            end
          end
        else
        ...
        if rfm.kind_of? Hash
          ...
          if rfm[:fields]
            rfm[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.requireFieldMatch"] = v
            end
          end
        else
        ...
        if mac.kind_of? Hash
          ...
          if mac[:fields]
            mac[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.maxAnalyzedChars"] = v
            end
          end
        else
        ...
        if prefix.kind_of? Hash
          ...
          if prefix[:fields]
            prefix[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.simple.pre"] = v
            end
          end
        else
        ...
        if suffix.kind_of? Hash
          ...
          if suffix[:fields]
            suffix[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.simple.post"] = v
            end
          end
        else
        ...
        if formatter.kind_of? Hash
          ...
          if formatter[:fields]
            formatter[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.formatter"] = v
            end
          end
        else
        ...
        if fragmenter.kind_of? Hash
          ...
          if fragmenter[:fields]
            fragmenter[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.fragmenter"] = v
            end
          end
        else
        ...
        if merge_contiguous.kind_of? Hash
          ...
          if merge_contiguous[:fields]
            merge_contiguous[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.mergeContiguous"] = v
            end
          end
        else
        ...
        if increment.kind_of? Hash
          ...
          if increment[:fields]
            increment[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.increment"] = v
            end
          end
        else
        ...
        if alternate_field.kind_of? Hash
          ...
          if alternate_field[:fields]
            alternate_field[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.alternateField"] = v
            end
          end
        else
        ...
        if mafl.kind_of? Hash
          ...
          if mafl[:fields]
            mafl[:fields].each do |k,v|
              hash["f.***REMOVED***{k}.hl.maxAlternateFieldLength"] = v
            end
          else
            ***REMOVED*** support "old style"
            mafl.each do |k,v|
          ...
          if regex[:slop].kind_of? Hash
            ...
            if regex[:slop][:fields]
              regex[:slop][:fields].each do |k,v|
                hash["f.***REMOVED***{k}.hl.regex.slop"] = v
              end
            end
          else
          ...
          if regex[:pattern].kind_of? Hash
            ...
            if regex[:pattern][:fields]
              regex[:pattern][:fields].each do |k,v|
                hash["f.***REMOVED***{k}.hl.regex.pattern"] = v
              end
            end
          else
          ...
          if regex[:max_analyzed_chars].kind_of? Hash
            ...
            if regex[:max_analyzed_chars][:fields]
              regex[:max_analyzed_chars][:fields].each do |k,v|
                hash["f.***REMOVED***{k}.hl.regex.maxAnalyzedChars"] = v
              end
            end
          else
