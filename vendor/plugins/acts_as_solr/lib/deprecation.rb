module ActsAsSolr ***REMOVED***:nodoc:
  ...
  class Deprecation
    ***REMOVED*** Validates the options passed during query
    ...
    ***REMOVED*** Validates the options passed during indexing
    ...
    ***REMOVED*** This will print the text to stdout and log the text
    ***REMOVED*** if rails logger is available
    def self.plog text
      puts text
