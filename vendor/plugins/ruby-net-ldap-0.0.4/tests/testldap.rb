***REMOVED*** $Id: testldap.rb 65 2006-04-23 01:17:49Z blackhedd $
***REMOVED***
***REMOVED***
...
class TestLdapClient < Test::Unit::TestCase
  ...
  ***REMOVED*** TODO: these tests crash and burn if the associated
  ***REMOVED*** LDAP testserver isn't up and running.
  ***REMOVED*** We rely on being able to read a file with test data
  ***REMOVED*** in LDIF format.
  ***REMOVED*** TODO, WARNING: for the moment, this data is in a file
  ***REMOVED*** whose name and location are HARDCODED into the
  ***REMOVED*** instance method load_test_data.
  ...
  ***REMOVED*** Get some test data which will be used to validate
  ***REMOVED*** the responses from the test LDAP server we will
  ***REMOVED*** connect to.
  ***REMOVED*** TODO, Bogus: we are HARDCODING the location of the file for now.
  ***REMOVED***
  def load_test_data
  ...
  ***REMOVED*** Binding tests.
  ***REMOVED*** Need tests for all kinds of network failures and incorrect auth.
  ***REMOVED*** TODO: Implement a class-level timeout for operations like bind.
  ***REMOVED*** Search has a timeout defined at the protocol level, other ops do not.
  ***REMOVED*** TODO, use constants for the LDAP result codes, rather than hardcoding them.
  def test_bind
  ...
  ***REMOVED*** This is a helper routine for test_search_attributes.
