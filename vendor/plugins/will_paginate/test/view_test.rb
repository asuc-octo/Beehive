...
class ViewTest < WillPaginate::ViewTestCase
  ...
  ***REMOVED******REMOVED*** basic pagination ***REMOVED******REMOVED***
  ...
  def test_will_paginate_with_options
    paginate({ :page => 2 },
      ...
      assert_select 'a[href]', 4 do |elements|
        ...
        ***REMOVED*** test rel attribute values:
  ...
  ***REMOVED******REMOVED*** advanced options for pagination ***REMOVED******REMOVED***
  ...
  ***REMOVED******REMOVED*** other helpers ***REMOVED******REMOVED***
  ...
  def test_paginated_section
    ...
    assert_select 'div.pagination + div***REMOVED***developers', 1
  end
  ...
  uses_mocha 'class name' do
    def test_page_entries_info_with_longer_class_name
      ...
      paginate collection
      assert @html_result.index('project types'), "expected <***REMOVED***{@html_result.inspect}> to mention 'project types'"
    end
  end
  ...
  ***REMOVED******REMOVED*** parameter handling in page links ***REMOVED******REMOVED***
  ...
  def test_adding_anchor_parameter
    ...
    assert_links_match /***REMOVED***anchor$/
  end
  ...
  ***REMOVED******REMOVED*** internal hardcore stuff ***REMOVED******REMOVED***
