...
class CoreImageTest < Test::Unit::TestCase
  ...
  if Object.const_defined?(:OSX)
    def test_should_resize_image
      ...
      ***REMOVED*** test core image thumbnail
      ...
      ***REMOVED*** This makes sure that we didn't overwrite the original file
      ***REMOVED*** and will end up with a thumbnail instead of the original
      assert_equal 42, attachment.width
      assert_equal 55, attachment.height
