...
class ImageWithThumbsClassFileAttachment < FileAttachment
  ***REMOVED*** use file_system_path to test backwards compatibility
...
***REMOVED*** no filename, no size, no content_type
...
begin
  ...
  class ImageThumbnailCrop < MiniMagickAttachment
    ...
    ***REMOVED*** TODO this is a bad duplication, this method is in the MiniMagick Processor
