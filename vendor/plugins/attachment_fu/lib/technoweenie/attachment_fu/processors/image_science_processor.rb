  ...
  module AttachmentFu ***REMOVED*** :nodoc:
    module Processors
      module ImageScienceProcessor
        ...
        module ClassMethods
          ***REMOVED*** Yields a block containing an Image Science image for the given binary data.
        ...
        protected
          ...
          ***REMOVED*** Performs the actual resizing operation for a thumbnail
          def resize_image(img, size)
            ***REMOVED*** create a dummy temp file to write to
            ***REMOVED*** ImageScience doesn't handle all gifs properly, so it converts them to
            ***REMOVED*** pngs for thumbnails.  It has something to do with trying to save gifs
            ***REMOVED*** with a larger palette than 256 colors, which is all the gif format
            ***REMOVED*** supports.
