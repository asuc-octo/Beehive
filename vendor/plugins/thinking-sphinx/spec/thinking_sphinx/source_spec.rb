...
describe ThinkingSphinx::Source do
  ...
  describe "***REMOVED***to_riddle_for_core" do
    before :each do
    ...
    it "should assign attributes" do
      ***REMOVED*** 3 internal attributes plus the one requested
    ...
    describe "***REMOVED***sql_query_range" do
      before :each do
    ...
    describe "***REMOVED***sql_query_info" do
      before :each do
      ...
      it "should filter the primary key with the offset" do
        ...
        @query.should match(/WHERE `id` = \(\(\$id - 1\) \/ ***REMOVED***{model_count}\)/)
      end
    end
    
    describe "***REMOVED***sql_query_pre" do
      before :each do
  ...
  describe "***REMOVED***to_riddle_for_core with range disabled" do
    before :each do
      ThinkingSphinx::Field.new(
        @source, ThinkingSphinx::Index::FauxColumn.new(:first_name)
      )
