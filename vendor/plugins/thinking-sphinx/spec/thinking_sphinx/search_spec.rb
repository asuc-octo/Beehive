...
describe ThinkingSphinx::Search do
  ...
  describe '***REMOVED***respond_to?' do
  ...
  describe '***REMOVED***method_missing' do
    before :each do
  ...
  describe '.search' do
    it "return the output of ThinkingSphinx.search" do
      @results = [] ***REMOVED*** to confirm same object
  ...
  describe '***REMOVED***populate' do
    ...
    describe 'sql ordering' do
      ...
      it "should use the option for the ActiveRecord::Base***REMOVED***find calls" do
    ...
    context 'result objects' do
      ...
      describe '***REMOVED***sphinx_attributes' do
        before :each do
          @search = ThinkingSphinx::Search.new
        end
      ...
      describe '***REMOVED***matching_fields' do
  ...
  describe '***REMOVED***current_page' do
  ...
  describe '***REMOVED***total_pages' do
  ...
  describe '***REMOVED***previous_page' do
  ...
  describe '***REMOVED***total_entries' do
  ...
  describe '***REMOVED***excerpt_for' do
    before :each do
