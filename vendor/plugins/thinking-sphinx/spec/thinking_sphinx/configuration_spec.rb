...
describe ThinkingSphinx::Configuration do
  ...
  describe '***REMOVED***version' do
    ...
    it "should use the given version from sphinx.yml if there is one" do
      open("***REMOVED***{RAILS_ROOT}/config/sphinx.yml", "w") do |f|
      ...
      FileUtils.rm "***REMOVED***{RAILS_ROOT}/config/sphinx.yml"
    end
  ...
  it "should insert set index options into the configuration file" do
    ...
    ThinkingSphinx::Configuration::IndexOptions.each do |option|
      ...
      file.should match(/***REMOVED***{option}\s+= something/)
  ...
  describe '***REMOVED***models_by_crc' do
    before :each do
      @config = ThinkingSphinx::Configuration.instance
    end
