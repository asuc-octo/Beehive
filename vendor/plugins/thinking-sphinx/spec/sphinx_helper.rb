...
require "active_record/connection_adapters/***REMOVED***{prefix}mysql_adapter"
begin
  require "active_record/connection_adapters/***REMOVED***{prefix}postgresql_adapter"
rescue LoadError
  ***REMOVED*** No postgres?  no prob...
end
require 'yaml'
