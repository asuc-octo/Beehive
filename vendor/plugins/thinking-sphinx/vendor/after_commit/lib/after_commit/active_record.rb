  ...
  module ActiveRecord
    def self.included(base)
      base.class_eval do
        ...
        ***REMOVED*** The define_callbacks method was added post Rails 2.0.2 - if it
        ***REMOVED*** doesn't exist, we define the callback manually
        if respond_to?(:define_callbacks)
          ...
          class << self
            ***REMOVED*** Handle after_commit callbacks - call all the registered callbacks.
