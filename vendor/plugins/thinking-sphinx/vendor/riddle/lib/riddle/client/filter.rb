module Riddle
  class Client
    class Filter
      ...
      ***REMOVED*** Attribute name, values (which can be an array or a range), and whether
      ***REMOVED*** the filter should be exclusive.
      ...
      ***REMOVED*** Returns the message for this filter to send to the Sphinx service
      def query_message
        message = Message.new
      ...
      ***REMOVED*** Using to_f is a hack from the PHP client - to workaround 32bit signed
      ***REMOVED*** ints on x32 platforms
