...
***REMOVED*** Looking for more documentation? A good place to start is Xapit::Membership
module Xapit
  ***REMOVED*** Index all membership classes with xapit defined. Delegates to Xapit::IndexBlueprint.
  ...
  ***REMOVED*** Used to perform a search on all indexed models. The returned collection can
  ***REMOVED*** contain instances of different classes which were indexed.
  ***REMOVED*** 
  ***REMOVED***   ***REMOVED*** perform a simple full text search
  ***REMOVED***   @records = Xapit.search("phone")
  ***REMOVED*** 
  ***REMOVED*** See Xapit::Membership for details on search options.
  def self.search(*args)
    Collection.new(nil, *args)
  end
  
  ***REMOVED*** Setup configuration options. The following options are supported.
  ***REMOVED*** 
  ***REMOVED*** <tt>:database_path</tt>:     Where the database is stored.
  ***REMOVED*** <tt>:stemming</tt>:          The language to use for stemming, defaults to "english".
  ***REMOVED*** <tt>:spelling</tt>:          True or false to enable/disable spelling, defaults to true.
  ***REMOVED*** <tt>:indexer</tt>:           Class to handle the indexing, defaults to SimpleIndexer.
  ***REMOVED*** <tt>:query_parser</tt>:      Class to handle the parsing, defaults to ClassicQueryParser.
  ***REMOVED*** <tt>:breadcrumb_facets</tt>: Use breadcrumb mode for applied facets. See Collection***REMOVED***applied_facet_options for details.
  ***REMOVED***
  def self.setup(*args)
    Config.setup(*args)
  end
