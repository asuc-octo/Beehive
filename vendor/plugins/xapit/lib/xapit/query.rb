module Xapit
  ***REMOVED*** This class wraps a Xapian::Query for convenience purposes. You will likely not need to use
  ***REMOVED*** this class unless you are trying to query the Xapian database directly.
  ***REMOVED*** You may be looking for Xapit::Collection instead.
  class Query
    ...
    def count
      ***REMOVED*** a bit of a hack to get more accurate count estimate
    ...
    def xapian_operator(operator)
      ...
      else raise "Unknown Xapian operator ***REMOVED***{operator}"
      end
    end
  end
end
