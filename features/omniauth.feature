...
Scenario: Log in and log out as different user with OmniAuth as backend.
  ...
  ***REMOVED***Given I am logged in as "764489"
  And I go to the home page
  Then I should see "Logged in as Henry Kwan"
  When I log out
  Then I should see "Log In"
  ***REMOVED***Given I am logged in as "758711"
***REMOVED***Then I should not see "Logged in as Henry Kwan"
***REMOVED***And I should see "Logged in as Winston C Lee"
