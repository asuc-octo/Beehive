...
***REMOVED*** The generated `.rspec` file contains `--require spec_helper` which will cause
***REMOVED*** this file to always be loaded, without a need to explicitly require it in any
***REMOVED*** files.
***REMOVED***
...
***REMOVED*** the additional setup, and require it from the spec files that actually need
***REMOVED*** it.
***REMOVED***
...
=begin
  ...
  ***REMOVED*** Allows RSpec to persist some state between runs in order to support
  ***REMOVED*** the `--only-failures` and `--next-failure` CLI options. We recommend
  ***REMOVED*** you configure your source control system to ignore this file.
  config.example_status_persistence_file_path = "spec/examples.txt"

  ***REMOVED*** Limits the available syntax to the non-monkey patched syntax that is
  ***REMOVED*** recommended. For more details, see:
  ***REMOVED***   - http://myronmars.to/n/dev-blog/2012/06/rspecs-new-expectation-syntax
  ***REMOVED***   - http://www.teaisaweso.me/blog/2013/05/27/rspecs-new-message-expectation-syntax/
