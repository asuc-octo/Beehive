...
$(function() { 
    ...
    autocomplete_setup('/courses/json', '***REMOVED***course_name');
    autocomplete_setup('/categories/json', '***REMOVED***category_name');
    autocomplete_setup('/proglangs/json', '***REMOVED***proglang_name');                
});
